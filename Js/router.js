...
const routes = {
    "/": { template: "views/dashboard.html", scriptId: "dashboard" },
    "/dashboard": { template: "views/dashboard.html", scriptId: "dashboard" },
    ...
    "/reports": { template: "views/reports.html", scriptId: "reports" },
